...
Работа с удаленными репозиториями. Скачивания из текущего репозитория и слияние со своей версией.

Освоить работу с удаленными репозиториями, которые находяться не на локальном устройстве, а на удаленном. Например на сервере
. Копировать внешний репозиторий можно командой git clone
